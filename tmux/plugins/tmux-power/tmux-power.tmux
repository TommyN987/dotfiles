...
user=$(whoami)
LS="#[fg=$G13,bg=$TC,bold] $user_icon $user #[fg=$TC,bg=$G06,nobold]$rarrow #[fg=$G01,bg=$G06] $session_icon #S "
...
RS="#[fg=$G06]$larrow#[fg=$G01,bg=$G06] $time_icon $time_format #[fg=$TC,bg=$G06]$larrow#[fg=$G04,bg=$TC]#[fg=$G13,bg=$TC] $date_icon $date_format "
...
tmux_set window-status-format         "#[fg=$BG,bg=$G06]$rarrow#[fg=$G05,bg=$G06] #I:#W#F #[fg=$G06,bg=$BG]$rarrow"
tmux_set window-status-current-format "#[fg=$BG,bg=$G14]$rarrow#[fg=$G01,bg=$G14,bold] #I:#W#F #[fg=$G14,bg=$BG,nobold]$rarrow"
